...
class MyUI:
    def __init__(self, root):
        self.myRoot = root
        root.bind("<k>", self.forward)
        root.bind("<j>", self.backward)
        ...
        self.FrameE.grid(row=0, column=4)
    ...
    def buildui(self):
        ...
        ln1 = Label(self.FrameNote, text="Press J as left", bg="yellow", fg="purple")
        ln1.grid(row=0, column=0)
        ln2 = Label(self.FrameNote, text="Press K as right", bg="yellow", fg="purple")
