// OSX compilation:
//    g++ -std=c++11 -I/opt/X11/include -o myfilter1 tbb_myfilter1.cpp -L/opt/X11/lib -lX11 -ljpeg -ltbb
...
main(int argv, char *argc[])
{
	...
	cout << "\nreading the list sequentially, processing every image in parallel\n" << endl; 
